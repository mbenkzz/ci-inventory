...
<body class="sb-nav-fixed">
									...
									<form id="edit_barang">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<!-- stok -->
													<label class="mb-1 font-size-20" for="inputStock">Perbaiki Stok</label>
													<input type="text" class="form-control" id="inputStock" name="stock" value="<?= str_replace('.', ',', $item->stock) ?>">
													<small class="form-text text-danger"></small>
												</div>
											</div>
											<?php endif; ?>
	...
	<script>
		...
		$(document).on('input', '#inputStock', function() {
