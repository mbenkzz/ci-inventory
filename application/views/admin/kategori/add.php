                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="inputName" name="name" type="text" placeholder="Masukkan nama kategori" maxlength="64"/>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="inputDescription" name="description" rows="3" placeholder="Deskripsi / Keterangan"></textarea>
                                                    <small class="form-text text-danger"></small>
                                                </div>
                                            </div>
                                        </div>
