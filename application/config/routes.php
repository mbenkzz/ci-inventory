...
$route['admin_dapur/dashboard/api/chart_profit'] = 'dashboardController/get_chart_profit';
...
$route['admin_dapur/transaction/random'] = 'cashierController/randomSeedingTransaction';
